export default interface CustomerOrder {
    ...
    orderLines?: CustomerOrderLine[] | null;
    additionalDocumentReferences?: CustomerOrderAdditionalDocumentReference[] | null;
    allowanceCharges?: CustomerOrderAllowanceCharge[] | null;
  ...
  export interface CustomerOrderLine {
    ...
    lineItem: CustomerOrderLineItem | null;
    metadata?: string | null;
    note?: string | null;
  ...
  export interface CustomerOrderLineAdditionalItemProperty {
    id: string;
    name: string;
    orderLineId: string;
    value: string;
  }
  export interface CustomerOrderLineItemCommodityClassifcation {
    id: string;
    invoiceLineId: string;
    itemClassificationCodeListId: string;
    itemClassificationCodeListVersionId: string;
  }
  export interface CustomerOrderLineItemInstance {
  ...
  export interface CustomerOrderTaxSubtotal {
    id: string;
    orderId: string;
  ...
  export interface CustomerOrderAdditionalDocumentReference {
  ...
  export interface CustomerOrderAllowanceCharge {
