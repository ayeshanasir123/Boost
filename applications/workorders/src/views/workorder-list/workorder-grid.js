...
export const useGridConfig = () => {
    const statuses = ['Not started', 'In progress', 'Paused', 'Reviewing', 'Completed', 'New'];
    const statusColors = ['gray', 'blue', 'yellow', 'light-blue', 'green'];
    const dummyContractor = ['', 'Transtema Charge Göteborg', 'Contractor 2', 'Contractor 3', 'Reviewing', 'Completed'];
